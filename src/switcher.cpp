...
// ===================================================================
// connectChat with token logging and original room-id callback
// ===================================================================
void Switcher::connectChat()
{
    ...
    if (wantPubSub) {
        ...
        // Original room-id callback – PubSub starts when chat provides the ID
...
// ===================================================================
// All the original Switcher methods (unchanged)
// ===================================================================
...
void Switcher::handleRistStaleFrameFix(bool offline) { /* ... unchanged ... */ }
void Switcher::handleOfflineTimeout() { /* ... unchanged ... */ }
void Switcher::handleStartingScene() { /* ... unchanged ... */ }
SwitchType Switcher::getOnlineServerStatus(StreamServer** activeServer) { /* ... unchanged ... */ }
SwitchType Switcher::getOnlineServerStatusLocked(StreamServer** activeServer) { /* ... unchanged ... */ }
void Switcher::switchToScene(const std::string &sceneName) { /* ... unchanged ... */ }
std::string Switcher::getSceneForType(SwitchType type, StreamServer* server) { /* ... unchanged ... */ }
bool Switcher::isSceneSwitchable(const std::string &scene) { /* ... unchanged ... */ }
std::string Switcher::getCurrentScene() { /* ... unchanged ... */ }
void Switcher::switchToLive() { /* ... unchanged ... */ }
void Switcher::switchToPrivacy() { /* ... unchanged ... */ }
void Switcher::switchToStarting() { /* ... unchanged ... */ }
void Switcher::switchToEnding() { /* ... unchanged ... */ }
void Switcher::refreshScene() { /* ... unchanged ... */ }
void Switcher::fixMediaSources() { /* ... unchanged ... */ }
void Switcher::switchToLow() { /* ... unchanged ... */ }
void Switcher::switchToBrb() { /* ... unchanged ... */ }
void Switcher::triggerSwitch() { /* ... unchanged ... */ }
bool Switcher::switchToSceneByName(const std::string &name) { /* ... unchanged ... */ }
BitrateInfo Switcher::getLastBitrateInfo() const { /* ... unchanged ... */ }
BitrateInfo Switcher::getCurrentBitrate() { /* ... unchanged ... */ }
std::string Switcher::getStatusString() { /* ... unchanged ... */ }
std::string Switcher::getCachedStatusLine() { /* ... unchanged ... */ }
std::string Switcher::getCachedBitrateLine() { /* ... unchanged ... */ }
